...
public class KampusApp {
    ...
    public void menuTambah() {
        ...
        if ("1".equals(idProdi) || "2".equals(idProdi) || "3".equals(idProdi)) {
            Mahasiswa mahasiswa = new Mahasiswa(nim, nama, idProdi);
            db.mahasiswaTbl.create(mahasiswa);
            System.out.println("* Data Mahasiswa berhasil ditambahkan *");
        } else {
            System.out.println("ID Prodi tidak valid. Hanya diperbolehkan ID Prodi 1, 2, atau 3.");
        }
    ...
    public void menuCari(){
        ...
        if(mahasiswa == null) {
            ...
            if ("1".equals(mahasiswa.getidProdi())) {
                System.out.println("* Prodi: Sistem Informasi *");
            }else if ("2".equals(mahasiswa.getidProdi())) {
                System.out.println("* Prodi: informatika *");
            }else if ("3".equals(mahasiswa.getidProdi())) {
                System.out.println("* Prodi: Elektro *");
            } else {
